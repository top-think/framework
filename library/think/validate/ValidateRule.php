 ...
 * @method ValidateRule isRequire(null $rule=null, string $msg = '') static 验证字段必须
 * @method ValidateRule isNumber(null $rule=null, string $msg = '') static 验证字段值是否为数字
 * @method ValidateRule isArray(null $rule=null, string $msg = '') static 验证字段值是否为数组
 * @method ValidateRule isInteger(null $rule=null, string $msg = '') static 验证字段值是否为整形
 * @method ValidateRule isFloat(null $rule=null, string $msg = '') static 验证字段值是否为浮点数
 * @method ValidateRule isMobile(null $rule=null, string $msg = '') static 验证字段值是否为手机
 * @method ValidateRule isIdCard(null $rule=null, string $msg = '') static 验证字段值是否为身份证号码
 * @method ValidateRule isChs(null $rule=null, string $msg = '') static 验证字段值是否为中文
 * @method ValidateRule isChsDash(null $rule=null, string $msg = '') static 验证字段值是否为中文字母及下划线
 * @method ValidateRule isChsAlpha(null $rule=null, string $msg = '') static 验证字段值是否为中文和字母
 * @method ValidateRule isChsAlphaNum(null $rule=null, string $msg = '') static 验证字段值是否为中文字母和数字
 * @method ValidateRule isDate(null $rule=null, string $msg = '') static 验证字段值是否为有效格式
 * @method ValidateRule isBool(null $rule=null, string $msg = '') static 验证字段值是否为布尔值
 * @method ValidateRule isAlpha(null $rule=null, string $msg = '') static 验证字段值是否为字母
 * @method ValidateRule isAlphaDash(null $rule=null, string $msg = '') static 验证字段值是否为字母和下划线
 * @method ValidateRule isAlphaNum(null $rule=null, string $msg = '') static 验证字段值是否为字母和数字
 * @method ValidateRule isAccepted(null $rule=null, string $msg = '') static 验证字段值是否为yes, on, 或是 1
 * @method ValidateRule isEmail(null $rule=null, string $msg = '') static 验证字段值是否为有效邮箱格式
 * @method ValidateRule isUrl(null $rule=null, string $msg = '') static 验证字段值是否为有效URL地址
 ...
 * @method ValidateRule must(null $rule=null, string $msg = '') static 必须验证
 */
class ValidateRule
{
    // 验证字段的名称
