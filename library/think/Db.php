...
class Db
{
    ...
    {
        return $this->connection->insert($this, $data, $replace, $getLastInsID, $sequence);
    }
    ...
    {
        return $this->connection->insert($this, $data, $replace, true, $sequence);
    }
    ...
    {
        return $this->connection->update($this, $data);
    }
    ...
    {
        return $this->connection->delete($this, $data);
    }
    ...
    public function select($data = null)
    {
        ...
        $resultSet = $this->connection->select($this, $data);
    ...
    public function find($data = null)
    {
        ...
        $result = $this->connection->find($this, $data);
