...
class Hook
{
     ...
     * @return boolean
     */
    public static function isStatic($tag)
    {
        if (isset(self::$tags[$tag]['static']) && self::$tags[$tag]['static'] === true) {
            return true;
        } else {
            return false;
        }
     ...
     * @return type
     */
    public static function setStatic($tag, $bl = true)
    {
        return self::$tags[$tag]['static'] = $bl;
    }
