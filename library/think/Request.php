...
class Request
{
    ...
    public function __construct($options = [])
    {
        ...
        if (is_null($this->filter)) {
            $this->filter = ConfigFacade::get('default_filter');
        }
        // 保存 php://input
    ...
    public function pathinfo()
    {
        if (is_null($this->pathinfo)) {
            if (isset($_GET[ConfigFacade::get('var_pathinfo')])) {
                // 判断URL里面是否有兼容模式参数
                $_SERVER['PATH_INFO'] = $_GET[ConfigFacade::get('var_pathinfo')];
                unset($_GET[ConfigFacade::get('var_pathinfo')]);
            } elseif ($this->isCli()) {
            ...
            if (!isset($_SERVER['PATH_INFO'])) {
                foreach (ConfigFacade::get('pathinfo_fetch') as $type) {
    ...
    public function path()
    {
        if (is_null($this->path)) {
            $suffix   = ConfigFacade::get('url_html_suffix');
    ...
    public function method($method = false)
    {
        if (true === $method) {
            ...
            if (isset($_POST[ConfigFacade::get('var_method')])) {
                $this->method = strtoupper($_POST[ConfigFacade::get('var_method')]);
    ...
    public function isAjax($ajax = false)
    {
        ...
        if (true === $ajax) {
            ...
            return $this->param(ConfigFacade::get('var_ajax')) ? true : $result;
        }
    }
    ...
    public function isPjax($pjax = false)
    {
        ...
        if (true === $pjax) {
            ...
            return $this->param(ConfigFacade::get('var_pjax')) ? true : $result;
        }
    }
