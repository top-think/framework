...
class BelongsToMany extends Relation
{
     ...
     * @return array
     */
    protected function eagerlyManyToMany(array $where, string $relation, string $subRelation = '', Closure $closure = null): array
    {
        // 预载入关联查询 支持嵌套预载入
     ...
     * @return Query
     */
    protected function belongsToManyQuery(string $foreignKey, string $localKey, array $condition = [], Closure $closure = null): Query
    {
        if ($closure) {
            $closure($this->query);
        }
